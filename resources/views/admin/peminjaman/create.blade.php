    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 bg-white rounded-lg shadow-md">
                <h3 class="text-lg font-semibold text-gray-800 mb-6">➕ Tambah Data Peminjaman</h3>
                ...
                <form action="{{ route('admin.peminjaman.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_admin" id="nama_admin" value="{{ auth()->user()->name }}" readonly
                    ...
                    <div class="flex space-x-4 pt-4">
                        <button type="submit" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white">Simpan</button>
