    ...
    <div class="bg-white shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                <a class="text-lg font-bold text-red-600 md:text-xl hover:text-yellow-400 transition-colors duration-200"
                    href="/">
                    <img src="{{ asset('images/logo Mesin.png') }}" alt="Resto & Cafe Mas Bro"
                        class="w-full md:w-1/3 rounded-3xl object-cover h-100 shadow-md border-10 border-yellow-400"
        ...
        <div class="container mx-auto flex flex-wrap items-start justify-center px-4 lg:justify-between">
            ...
            <div class="w-full md:w-1/3 mb-8 md:mb-0 text-center">
                ...
                <div class="flex justify-center space-x-6">
                    <a href="https://www.facebook.com/share/15nQ8GE4yT/" target="_blank"
                        class="text-white hover:text-gray-200">
                        <i class="fab fa-facebook fa-2x"></i>
                    </a>
                    <a href="https://www.instagram.com/penyetan_masbro?igsh=N210NGptcTBicnNn" target="_blank"
                        class="text-white hover:text-gray-200">
